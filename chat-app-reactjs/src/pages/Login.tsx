...
if(isResgister){
  ...
  const handleChange =(e: React.ChangeEvent<HTMLInputElement>, typeInput:string) =>{
    setFormData((prevState:formDataType ) => ({ ...prevState, [typeInput]: e.target.value }));
    ...
    <div className="flex w-full h-full justify-center items-center ">
      <div className="w-[30rem] min-h-28 px-6 py-8 text-center border-primary border rounded-sm m-6 self-center">
        ...
        <div className="flex justify-between mt-4 text-primary">
          {isResgister  ? (
            <p onClick={handleLogIn} className="cursor-pointer text-primary hover:underline">
              Đăng nhập ngay
            </p>
          ) : (
            <>
